...
import { AccountController, AssetUtil, EventsController, NetworkController, RouterController, RouterUtil } from '@web3modal/core';
...
let W3mNetworksView = class W3mNetworksView extends LitElement {
    ...
    networksTemplate() {
        ...
        return requestedNetworks?.map(network => html `
        <wui-card-select
